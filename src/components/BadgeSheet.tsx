...
/**
 * Badge icons. Animals lead — kids pick a spirit animal — then a handful of
 * punchy symbols. Legible at disc size and in bright sun.
 */
const EMOJI = [
  // Full-body land animals (the side-on ones) lead the list.
  '🐅', '🐆', '🦁', '🐎', '🦄', '🦓', '🫏', '🦌', '🫎', '🐘',
  '🦣', '🦏', '🦛', '🐪', '🐫', '🦒', '🦙', '🐂', '🐃', '🐄',
  '🐖', '🐏', '🐑', '🐐', '🦬', '🦘', '🦥', '🦦', '🦨', '🦡',
  '🦫', '🦝', '🐕', '🦮', '🐩', '🐈', '🦔', '🐿️', '🐇', '🐁',
